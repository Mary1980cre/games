...
document.getElementById('btnTobegin').addEventListener('click', function () {   
    document.querySelector('.title-page').classList.add('invisible');              
    document.querySelector('.value-range').classList.remove('invisible');          
    document.querySelector('.valueRange').classList.remove('invisible');           
    document.querySelector('.form-inline').classList.remove('invisible');          
    document.querySelector('#btnTobegin').classList.add('invisible');              
    document.querySelector('#btnProceed').classList.remove('invisible');           
})
